...
#define EVENT_MAXLENGTH          32
#define MAP_LINE_MAXLENGTH       4096
#define KEY_NAME_MAXLENGTH       32
#define MOUSE_ACTION_MAXLENGTH   32
#define MOUSE_MOVE_MAXLENGTH     6
#define HID_MAX_INTERFACES       4
